...
const MyModal: React.FC<MyModalProps> = ({errorMsg}) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex justify-center items-center z-50">
      <div className="bg-white bg-opacity-90 rounded-lg p-6 w-full max-w-md shadow-lg">
        <h2 className="text-xl font-semibold ">Square Catalog</h2>
        <h2 className="text-md text-red-500 text-center mb-4">{errorMsg}</h2>
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label htmlFor="description" className="block text-sm font-medium text-gray-700">Square Access Token:</label>
            <textarea
              id="square"
              name="square"
