...
interface ModalErrorProps {
  setShowModal: React.Dispatch<React.SetStateAction<boolean>>; // Assuming it's a setter for state
  msg:string
}

const ModalError: React.FC<ModalErrorProps> = ({ setShowModal , msg }) => {
  const handleAccept = () => {
    setShowModal(false);
  };
    ...
    <div className='absolute left-[40%] z-50'>
      <div className="card">
        ...
        <div className="buttonContainer">
          <button className="acceptButton" onClick={handleAccept}>Close</button>
