...
interface NewTemplate {
  ...
  btn?: string
  btnUrl?: string
  headerImage?: File | null // Add this for file upload
  headerImagePreview?: string // Add this for preview URL
}
...
export default function NewsletterApp() {
  ...
  //     // In a real implementation, you would upload the file to a cloud service here
...
33123456789,Charlie Wilson`
    ...
    reader.onload = (e) => {
      try {
        ...
        for (let i = 1; i < lines.length; i++) {
          ...
          const customerName = customerNameRaw.trim() || null // Store as null if empty
  ...
  const handleStartCampaign = useCallback(async () => {
    ...
    if (!validateStep2()) {
      errors.push("• Please set a valid daily sending limit and schedule")
    }
    if (!validateStep3()) {
...
const isVideoUrl = (url: string) => {
  ...
  // const getLivePreviewTemplate = useCallback(() => {
            ...
            {activeStep === 0 && (
              <Card>
                <CardHeader
                  ...
                  subheader="Upload a CSV file with exactly 2 columns: Phone Number and Customer Name"
                />
                <CardContent>
                  <Stack spacing={3}>
                    <Alert severity="info">
                      ...
                      <ul style={{ margin: 0, paddingLeft: 20 }}>
                        ...
                        <li>
                          <strong>Customer names:</strong> Optional. If provided, at least 2 characters long.
                        </li>
                        <li>
                          <strong>File structure:</strong> Exactly 2 columns only
                        </li>
                        <li>
                    ...
                    >
                      ...
                      >
                        {isDragOver ? "Drop your CSV file here" : "Drag & Drop CSV File"}
                      </Typography>
                      ...
                      >
                        {isParsingCsv ? "Parsing..." : "Choose CSV File"}
                      </Button>
                    ...
                    {csvErrors.length > 0 && (
                      <Alert severity="error">
                        <AlertTitle>Parsing Errors ({csvErrors.length})</AlertTitle>
                    ...
                    {csvErrors.length > 0 && csvData.length === 0 && (
                      <Alert severity="warning">
                        ...
                        Please fix all errors in your CSV file before proceeding to the next step. You need at least one
                        valid contact to continue.
                      </Alert>
                    )}
                                  ...
                                  <Box>
                                    ...
                                    >
                                      <Stack direction="row" spacing={2} alignItems="center">
                                        ...
                                        >
                                          <img
                                            src={newTemplate.headerImagePreview}
                                            alt="Header preview"
                                            style={{
                                              width: "100%",
                                              height: "100%",
                                        ...
                                        <Box sx={{ flex: 1 }}>
                                          ...
                                          <Typography variant="caption" color="text.secondary">
                                            {newTemplate.headerImage && (newTemplate.headerImage.size / 1024).toFixed(2)} KB
                                          </Typography>
                        ...
                        <Paper sx={{ p: 2, border: "1px solid", borderColor: "divider" }}>
                          <Stack spacing={2}>
                            ...
                            <TextField
                              ...
                              placeholder="Start shopping! 🛍️"
                              fullWidth
                              helperText={`${newTemplate.btn?.length || 0}/25`}
                            />
                            {newTemplate.btn && (
                              <TextField
                                label="Button URL"
                      ...
                      <Stack spacing={1}>
                        <Stack direction="row" alignItems="center" spacing={1}>
                          ...
                          <Typography color={validateStep1() ? "success.main" : "error.main"} variant="body2">
                            CSV File:{" "}
                            {validateStep1() ? `${csvData.length} contacts loaded` : "No valid CSV file uploaded"}
                          </Typography>
                        </Stack>
                        <Stack direction="row" alignItems="center" spacing={1}>
                          {validateStep2() ? (
