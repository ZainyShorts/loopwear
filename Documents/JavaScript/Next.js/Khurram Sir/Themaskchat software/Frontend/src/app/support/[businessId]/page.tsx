...
import { ENDPOINTS, getBaseUrl, getWebSocketUrl } from "@/api/vars/vars"
...
// const businessId = "1005255797441315" // Your static business ID
...
export default function InboxPage() {
  ...
  const handleSendMessage = useCallback(async () => {
    ...
    let messageType: "Image" | "Audio" | "Text" | "Video" | "Pdf" | "Xlsx" | "Csv" | "Docx" | "Template" = "Text" // default type
  ...
  const handleLogout = async () => {
    try {
      const res = await axios.post(
        `${getBaseUrl()}account/${ENDPOINTS.logout}/`,
        {},
        {
          headers: {
  ...
  useEffect(() => {
    const socket: any = connectToBusinessNotifications()
    if (socket) setBusinessSocket(socket)
  ...
  return (
    <>
      ...
      <Card className="shadow-xl">
        ...
        <Box className="p-4 md:p-6 border-b bg-gradient-to-r from-blue-600 to-blue-700 flex items-center justify-between shadow-md">
          <Box>
          ...
          {isMobile ? (
            <>
              ...
              <ChatContainer>
                {selectedCustomer ? (
                  <>
                    <Box className="p-3 sm:p-4 border-b bg-gradient-to-r from-blue-50 to-white shadow-sm">
                                          ...
                                          >
                                            {message.type === "Image" ? (
                                              <img
                                                ...
                                                alt="Image"
                                                className="max-w-[200px] sm:max-w-[250px] rounded-xl cursor-pointer transition-transform hover:scale-105 shadow-md"
                                              ...
                                              <div
                                                ...
                                                className="flex items-center gap-3 px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 shadow-lg cursor-pointer hover:shadow-xl hover:scale-105 transition-all duration-200"
                                              >
                                                <Box className="h-10 w-10 sm:h-12 sm:w-12 flex items-center justify-center bg-white/20 rounded-xl backdrop-blur-sm">
                                                  <i className="tabler-file text-2xl sm:text-3xl text-white" />
                                                </Box>

                                                <Box className="flex flex-col">
                                                  <Typography className="font-bold text-sm sm:text-base text-white">
                                                    {message.type.toUpperCase()} File
                                                  </Typography>
                                                  <Typography className="text-xs text-blue-100">
                                                    Tap to download
                                                  </Typography>
                                                </Box>
                                              </div>
                                              ...
                                              <Typography
                                                className={classnames("font-medium text-sm sm:text-md", {
                    ...
                    <ChatInputContainer sx={{ padding: { xs: 1.5, sm: 2 } }}>
                              ...
                              <Box key={index} className="relative group">
                                {isImage && (
                                  <img
                                    ...
                                    className="h-14 w-14 sm:h-18 sm:w-18 object-cover rounded-lg border-2 border-blue-200 shadow-md group-hover:scale-105 transition-transform"
                                  />
                                )}
                                {isVideo && (
                                  <video
                                    src={previewURL}
                                    className="h-14 w-14 sm:h-18 sm:w-18 object-cover rounded-lg border-2 border-blue-200 shadow-md"
                                    muted
                                    autoPlay
                                    loop
                                  />
                                ...
                                {isAudio && (
                                  <Box className="h-14 w-14 sm:h-18 sm:w-18 flex items-center justify-center rounded-lg border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-blue-100 shadow-md">
                                    <AudiotrackIcon className="text-blue-600" />
                                  </Box>
                                )}
                                {isPDF && (
                                  <Box className="h-14 w-14 sm:h-18 sm:w-18 flex items-center justify-center rounded-lg border-2 border-red-200 bg-gradient-to-br from-red-50 to-red-100 font-bold text-red-600 text-xs shadow-md">
                                    PDF
                                  </Box>
                                )}
                                {isDocx && (
                                  <Box className="h-14 w-14 sm:h-18 sm:w-18 flex items-center justify-center rounded-lg border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-blue-100 font-bold text-blue-600 text-xs shadow-md">
                                    DOCX
                                  </Box>
                                )}
                                {isXlsx && (
                                  <Box className="h-14 w-14 sm:h-18 sm:w-18 flex items-center justify-center rounded-lg border-2 border-green-200 bg-gradient-to-br from-green-50 to-green-100 font-bold text-green-600 text-xs shadow-md">
                                    XLSX
                                  </Box>
                                )}
                                {isCsv && (
                                ...
                                <IconButton
                                  ...
                                  className="absolute -top-2 -right-2 bg-red-500 hover:bg-red-600 text-white shadow-lg hover:shadow-xl transition-all"
                      ...
                      <Box className="flex items-end gap-1 sm:gap-2">
                        ...
                        <Button
                          ...
                          className="min-w-[40px] sm:min-w-[44px] h-[40px] sm:h-[44px] shadow-md hover:shadow-lg transition-all hover:scale-105"
                          sx={{
                            padding: { xs: 1, sm: 1.5 },
                            borderRadius: "12px",
                          }}
                  ...
                  <Box className="flex-1 flex items-center justify-center p-4 bg-gradient-to-br from-blue-50 to-white">
                    <Box className="text-center">
                      ...
                      <Button
                        ...
                        onClick={() => setMobileDrawerOpen(true)}
                        className="mb-4 shadow-lg hover:shadow-xl transition-all hover:scale-105"
            ...
            <>
              ...
              <ChatContainer>
                {selectedCustomer ? (
                  <>
                    <Box className="p-4 border-b bg-gradient-to-r from-blue-50 to-white shadow-sm">
                      ...
                      {messagesLoading || switchingCustomer ? (
                        ...
                        <>
                          {messages && messages.length > 0 ? (
                                          ...
                                          >
                                            {message.type === "Image" ? (
                                              ...
                                              <div
                                                ...
                                                className="flex items-center gap-3 px-4 py-3.5 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 shadow-lg cursor-pointer hover:shadow-xl hover:scale-105 transition-all duration-200"
                                              >
                                                <Box className="h-12 w-12 flex items-center justify-center bg-white/20 rounded-xl backdrop-blur-sm">
                                                  <i className="tabler-file text-3xl text-white" />
                                                </Box>
                                              ...
                                              <div className="whatsapp-bubble shadow-lg">
                                                <div className="bubble-header">
                                                  <span className="text-xl">💬</span>
                                                  <span className="header-text font-semibold">WhatsApp Template</span>
                                                </div>

                                                <div className="bubble-message bg-white rounded-lg p-3">
                                                  {message.message}
                                                </div>
                                              </div>
                                            ) : (
                            ...
                            <Box className="flex-1 flex items-center justify-center">
                              <Box className="text-center">
                                <Box className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-blue-100 to-blue-200 rounded-full flex items-center justify-center shadow-lg">
                                  <i className="tabler-message-off text-4xl text-blue-600" />
                                </Box>
                                <Typography variant="h6" color="text.secondary" className="mb-2 font-semibold">
                                  No messages yet
                                </Typography>
                    ...
                    <ChatInputContainer>
                              ...
                              <Box key={index} className="relative group">
                                {isImage && (
                                  <img
                                    src={previewURL || "/placeholder.svg"}
                                    alt={`Selected ${index + 1}`}
                                    className="h-20 w-20 object-cover rounded-lg border-2 border-blue-200 shadow-md group-hover:scale-105 transition-transform"
                                  />
                                )}
                                {isVideo && (
                                  <video
                                    src={previewURL}
                                    className="h-20 w-20 object-cover rounded-lg border-2 border-blue-200 shadow-md"
                                    muted
                                    autoPlay
                                    loop
                                  />
                                ...
                                {isAudio && (
                                  <Box className="h-20 w-20 flex items-center justify-center rounded-lg border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-blue-100 shadow-md">
                                    <AudiotrackIcon className="text-blue-600" />
                                  </Box>
                                )}
                                {isPDF && (
                                  <Box className="h-20 w-20 flex items-center justify-center rounded-lg border-2 border-red-200 bg-gradient-to-br from-red-50 to-red-100 font-bold text-red-600 text-sm shadow-md">
                                    PDF
                                  </Box>
                                )}
                                {isDocx && (
                                  <Box className="h-20 w-20 flex items-center justify-center rounded-lg border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-blue-100 font-bold text-blue-600 text-sm shadow-md">
                                    DOCX
                                  </Box>
                                )}
                                {isXlsx && (
                                  <Box className="h-20 w-20 flex items-center justify-center rounded-lg border-2 border-green-200 bg-gradient-to-br from-green-50 to-green-100 font-bold text-green-600 text-sm shadow-md">
                                    XLSX
                                  </Box>
                                )}
                                {isCsv && (
                      ...
                      <Box className="flex items-end gap-2">
                        ...
                        <Button
                          ...
                          onClick={handleSendMessage}
                          disabled={(!newMessage.trim() && selectedImages.length === 0) || sendingMessage}
                          className="min-w-[48px] h-[48px] shadow-md hover:shadow-lg transition-all hover:scale-105"
                  ...
                  <Box className="flex-1 flex items-center justify-center bg-gradient-to-br from-blue-50 to-white">
                    <Box className="text-center p-8">
                      ...
                      <Typography variant="h5" color="text.secondary" className="mb-2 font-bold">
                        No customer selected
                      </Typography>
        ...
        >
          <DialogTitle className="font-bold text-xl flex items-center gap-2">
            <i className="tabler-alert-circle text-orange-500 text-2xl" />
            Confirm Logout
          </DialogTitle>
          <DialogContent>
            <Typography>Are you sure you want to logout? You&apos;ll need to sign in again to access your inbox.</Typography>
          </DialogContent>
        ...
        >
          ...
          <DialogContent>
            <Typography>
              Are you sure you want to delete {selectedMessageIds.length} selected message(s)? This action cannot be
              undone.
            </Typography>
          </DialogContent>
          <DialogActions className="p-4">
        ...
        >
          <DialogTitle className="font-bold text-xl flex items-center gap-2">
            <i className="tabler-alert-triangle text-red-500 text-2xl" />
            Delete All Messages
          </DialogTitle>
          <DialogContent>
            <Typography>
              Are you sure you want to delete ALL messages with this customer? This action cannot be undone.
            </Typography>
          </DialogContent>
          <DialogActions className="p-4">
            <Button
      ...
      <style jsx global>{`
        ...
        .slide-in-from-bottom-2 {
          animation: slide-in-from-bottom-2 300ms ease;
        }

        .zoom-in-95 {
          animation: zoom-in-95 300ms ease;
        }
