...
// import OrdersChart from "./OrderChart/page"
...
//         // Find peak hour
//         const peak:any = hourlyData.reduce((max: any, item: any) => 
...
//       {/* Business Label */}
//       <Typography variant="subtitle2" sx={{ mb: 2, color: "text.secondary", textTransform: "uppercase" }}>
//         Analytics
//       </Typography>
...
//               <Box sx={{ mt: 3 }}>
//                 <Box sx={{ display: "flex", justifyContent: "space-between", mb: 1 }}>
//                   <Typography variant="body2">Fallback Rate</Typography>
//                   <Typography variant="body2" sx={{ fontWeight: 600 }}>
//                     8 %
//                   </Typography>
//                 </Box>
//                 <Box sx={{ height: 8, bgcolor: "action.disabledBackground", borderRadius: 1 }}>
//                   <Box sx={{ width: "8%", height: "100%", bgcolor: "error.main", borderRadius: 1 }} />
//                 </Box>
//               </Box>
...
//                   {["Lian Ting", "John Dae", "Pete Romame", "John Brown"].map((name, i) => (
//                     <Box key={i} sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
//                       <Typography variant="body2" color="text.secondary">
//                         {name}
//                       </Typography>
//                       <Box sx={{ width: 100, height: 6, bgcolor: "action.disabledBackground", borderRadius: 1 }}>
//                         <Box
//                           sx={{ width: `${80 - i * 15}%`, height: "100%", bgcolor: "primary.main", borderRadius: 1 }}
//                         />
//                       </Box>
//                     </Box>
//                   ))}
...
//                   <Typography variant="body2">AI handled 18%</Typography>
