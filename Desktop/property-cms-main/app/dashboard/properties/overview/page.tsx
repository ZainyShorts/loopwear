...
export default function PropertiesPage() {
  ...
  const handleApplyFiltersSidebar = (newFilters: any) => {
    setSearchFilter(newFilters)
    refetch({ filter: newFilters, sortBy: "createdAt", sortOrder: sortOrder })
  }
  ...
  const transformedData =
    data?.getProperties.map((property: any) => ({
      roadLocation: property.roadLocation || "",
      developmentName: property.developmentName || "",
      _id: property._id,
      subDevelopment: property.subDevelopmentName || "",
      projectName: property.projectName || "",
      propertyType: property.propertyType || "",
      propertyHeight: 0, // Not in API response
      projectLocation: property.projectLocation || "",
      unitNumber: property.unitNumber || 0,
      bedrooms: property.bedrooms || 0,
      unitLandSize: 0,
      unitBUA: 0,
      unitLocation: property.unitLocation || "",
      unitView: property.unitView || "",
      purpose: "",
      vacancyStatus: property.vacancyStatus || "",
      primaryPrice: property.primaryPrice || 0,
      resalePrice: property.resalePrice || 0,
      premiumLoss: (property.resalePrice || 0) - (property.primaryPrice || 0),
