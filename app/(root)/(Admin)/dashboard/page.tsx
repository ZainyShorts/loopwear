...
import { Menu, Users, UserCheck, UserX, BarChart3, ArrowLeft, FileText } from 'lucide-react'
        ...
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            ...
            >
              ...
              <DropdownMenuItem onClick={() => navigate('/policy')} className="py-3 px-4 flex items-center gap-2 cursor-pointer hover:bg-[#6b3419]/10 hover:text-[#6b3419] focus:bg-[#6b3419]/10 focus:text-[#6b3419]">
                <FileText className="h-4 w-4 text-[#6b3419]" />
                <span>View Policy</span>
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => navigate('/suspend-seller')} className="py-3 px-4 flex items-center gap-2 cursor-pointer hover:bg-[#6b3419]/10 hover:text-[#6b3419] focus:bg-[#6b3419]/10 focus:text-[#6b3419]">
                <UserX className="h-4 w-4 text-[#6b3419]" />
                <span>Suspend seller</span>
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => navigate('/reports')} className="py-3 px-4 flex items-center gap-2 cursor-pointer hover:bg-[#6b3419]/10 hover:text-[#6b3419] focus:bg-[#6b3419]/10 focus:text-[#6b3419]">
                <BarChart3 className="h-4 w-4 text-[#6b3419]" />
                <span>View Reports</span>
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => navigate('/manage-admin')} className="py-3 px-4 flex items-center gap-2 cursor-pointer hover:bg-[#6b3419]/10 hover:text-[#6b3419] focus:bg-[#6b3419]/10 focus:text-[#6b3419]">
                <UserCheck className="h-4 w-4 text-[#6b3419]" />
                <span>Manage Admin</span>
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => navigate('/manage-lender')} className="py-3 px-4 flex items-center gap-2 cursor-pointer hover:bg-[#6b3419]/10 hover:text-[#6b3419] focus:bg-[#6b3419]/10 focus:text-[#6b3419]">
                <Users className="h-4 w-4 text-[#6b3419]" />
                <span>Manage Lender</span>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
      ...
      <div className="container mx-auto px-4 mb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center transform transition-transform hover:scale-105">
            ...
            <h3 className="text-xl font-serif text-center mb-2 text-[#6b3419]">Total Seller</h3>
            <p className="text-center text-2xl font-bold text-gray-700">{stats.totalSellers}</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center transform transition-transform hover:scale-105">
            ...
            <h3 className="text-xl font-serif text-center mb-2 text-[#6b3419]">Suspended Sellers</h3>
            <p className="text-center text-2xl font-bold text-gray-700">{stats.suspendedSellers}</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center transform transition-transform hover:scale-105">
            ...
            <h3 className="text-xl font-serif text-center mb-2 text-[#6b3419]">Sales Summary</h3>
            <p className="text-center text-2xl font-bold text-gray-700">{stats.totalSales}</p>
          </div>
        </div>
      </div>
            ...
            <div className="w-full h-full flex flex-col">
              ...
              <div className="ml-8 h-full flex items-end border-l border-b border-gray-300 relative">
                ...
                <svg className="absolute inset-0 overflow-visible" preserveAspectRatio="none">
                  <polyline
                    points={salesData.map((value, index) => 
                      `${(index * (100 / (salesData.length - 1)))}% ${100 - (value / 9 * 100)}%`
                    ).join(' ')}
                    fill="none"
                    stroke="#3b82f6"
                    strokeWidth="2"
